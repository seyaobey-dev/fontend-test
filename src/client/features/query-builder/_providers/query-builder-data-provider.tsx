...
/**
 * This component uses the context api to expose
 * the array of groups (parent-child tree) being edited by user 
 * it also expposes methods to append/delete elements to/from the tree
 */
